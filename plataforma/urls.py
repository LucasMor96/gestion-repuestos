...
urlpatterns = [
    ...
    path(
        ...
        auth_views.PasswordResetView.as_view(
            template_name='plataforma/password_reset_form.html',
            email_template_name='plataforma/password_reset_email.txt',
            html_email_template_name='plataforma/password_reset_email.html',
